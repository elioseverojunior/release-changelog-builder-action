...
// eslint.config.mjs because the imported plugins
...
export default [
  {
    ...
    ignores: ["dist/**", "coverage/**", "node_modules/**", "**/*.d.ts", "golden-paths/**", ".worktrees/**"],
  },
  js.configs.recommended,
  {
    ...
    rules: {
      ...
      // Enforce strict TypeScript naming conventions across the project.
      // - camelCase for variables, functions, methods, and properties.
      // - PascalCase for classes, interfaces, typeAliases, and enums.
